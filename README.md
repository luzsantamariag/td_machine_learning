...
3. Biblioteca NumPy: numpy.ipynb: [![Notebook](https://img.shields.io/badge/Notebooks-Jupyter-orange)](code/numpy.ipynb), Google Colab: [![Numpy](https://colab.research.google.com/assets/colab-badge.svg)](https://drive.google.com/file/d/1le2E-IxW_UGw-1Tgle30lcXriDtUcXFD/view?usp=sharing)
4. Iris dataset: [![CSV](https://img.shields.io/badge/data-CSV-blue?style=flat-square)](datasets//iris.csv)
5. Laboratorio especies de la flor Iris:  ml_dtc.ipynb: [![Notebook](https://img.shields.io/badge/Notebooks-Jupyter-orange)](code/ml_dtc.ipynb)
